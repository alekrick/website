...
export const Header = ({ isScrollingDown = false, currentPage }: HeaderProps): JSX.Element => {
  ...
  return (
    <header
      data-testid="header"
      className={`sticky top-0 z-50 bg-white/95 dark:bg-[#0f0f0f]/95 backdrop-blur-sm border-b border-gray-200 dark:border-[#2a2a2a] shadow-sm transition-transform duration-300 will-change-transform ${
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden flex flex-col items-center gap-4 mt-4 py-2 border-t border-gray-200 dark:border-[#2a2a2a]" data-testid="mobile-menu">
            <Link
              href={URLS.routes.homepage}

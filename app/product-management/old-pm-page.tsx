...
const ProductManagement = (): JSX.Element => {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#0f0f0f] scroll-smooth overflow-x-hidden" data-testid="product-management-page">
      <Header isScrollingDown={isScrollingDown} currentPage="product-management" />

      {/* Hero Section */}
      <Section className="my-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#0f0f0f] py-12">
      ...
      {/* Value Proposition */}
      <Section className="my-16 md:my-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#0f0f0f]">
      ...
      <Section className="my-24 px-4 sm:px-6 lg:px-8 bg-gray-50/50 dark:bg-[#161616] py-12">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white text-3xl md:text-4xl font-bold shadow-lg mb-4">
              2
      ...
      <Section className="my-24 px-4 sm:px-6 lg:px-8 bg-gray-50/50 dark:bg-[#161616] py-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white text-3xl md:text-4xl font-bold shadow-lg mb-4">
              10
